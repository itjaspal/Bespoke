...
namespace api.Controllers
{
    public class CatalogSizeController : ApiController
    {
        ...
        [Route("catalog-size/get-size-catalog/{catalog}")]
        public HttpResponseMessage getSizeInCatalog(long catalog)
        {
            try
            {
                var result = sizeSvc.GetSizeInCatalog(catalog);
        ...
        [Route("catalog-size/get-filter-type/{catalog}/{type}")]
        public HttpResponseMessage getFilterType(long catalog, long type)
        {
            try
            {
                var result = sizeSvc.GetFilterType(catalog, type);
